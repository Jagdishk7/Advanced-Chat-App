...
export default function NoChat() {
  ...
  const openLinkedInProfile = () => {
    window.open("https://www.linkedin.com/in/jagdeesh-kushwaha-%E2%9A%9B%EF%B8%8F-0218aa230", "_blank");
  };

  const openGitHubProfile = () => {
    window.open("https://github.com/Jagdishk7", "_blank");
  };
  ...
  return (
    <NoChatContainer>
      ...
      <AnnotationContainer>
        <TextContainer>
          <ByText>By</ByText>
          <NameText onClick={openLinkedInProfile}>Jagdeesh Kushwaha</NameText>
        </TextContainer>
